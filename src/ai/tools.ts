...
const DOMAIN_PATTERNS: Record<ToolDomain, RegExp> = {
  ...
  widgets: /\b(widget|widgets|reloj|clima|temporizador|divisas?|recientes|tablero|ancla|anclar|anclado)\b/i,
  ...
  apps: /\b(app|aplicacion|aplicación|aplicaciones|navegador|terminal|ajustes|configuracion|configuración|tema|acento|fondo|apariencia|color|google|busca en internet)\b/i,
...
const COMMAND_DOMAINS: Record<string, ToolDomain> = {
  ...
  'apps.status': 'apps', 'ui.openApp': 'apps', 'ui.openApps': 'apps', 'ui.openBrowser': 'apps', 'ui.openTerminal': 'apps', 'ui.openSettings': 'apps', 'ui.theme': 'apps', 'ui.appearance': 'apps',
...
const PACKS: Record<ToolDomain, string[]> = {
  ...
  widgets: ['widgets.list', 'widgets.create', 'widgets.update', 'widgets.remove', 'widgets.place'],
  ...
  apps: ['ui.openBrowser', 'ui.openTerminal', 'ui.openSettings', 'ui.openApp', 'ui.openApps', 'apps.status', 'ui.theme', 'ui.appearance'],
